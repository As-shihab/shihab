...
const CreateUser = async ()=>{
  setLoading(true)
  await http.post('shihab/guyst' , userdata)
  .then(res=>{
    setLoading(false)
  ...
  return (
    <>
      ...
      <div className=" p-4 border border-slate-800 rounded-lg shadow-lg bg-boxdark shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex  items-center">
          <div className="hidden md:block w-full lg:block xl:block  xl:w-1/2">
            <div className="lg:py-17.5 lg:px-26 text-center">
              <Link className="mb-5.5 inline-block" to="/">
          <h1 className='uppercase text-5xl font-bold py-3 text-sky-300'>As-Shihab</h1>
                <img className="dark:hidden" src={LogoDark} alt="Logo" />
              </Link>

              <p className="2xl:px-20 my-2 mb-2">
              Bring the world closure togather , make you connectivity join with shihab management system 
              </p>
          ...
          <div className="w-full  border-slate-800 p-4  dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">{msg? msg : "Get started from here"}</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Get Started with shihab clouds
              </h2>
              ...
              <div className="mb-4 sm:w-full">
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/contact/login" className="text-primary">
