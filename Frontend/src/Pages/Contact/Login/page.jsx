...
const SignIn = async ()=>{
  setLoading(true)
http.post('shihab/guyst/login' , signdata)
.then(res=>{
  setLoading(false)
    ...
    <>
      ...
      <div className=" p-4 border border-slate-800 rounded-lg shadow-lg bg-boxdark shadow-default dark:border-strokedark dark:bg-boxdark">
        <div className="flex  items-center">
          <div className="hidden lg:block w-full xl:block xl:w-1/2">
          ...
          <div className="w-full  border-slate-800 p-4  dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Get started from here</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
               {message?message :"Sign In to Shihab Clouds"}
              </h2>
              ...
              <form>
                ...
                <div className="mt-6 text-center">
                  <p>
                    ...
                    <Link to="/contact/signup" className="text-sky-500">
                      Sign Up
                    </Link>
                  </p>
                </div>
